...
export function FreeChapters() {
  return (
    <section
      ...
      className="scroll-mt-14 bg-purple-600 sm:scroll-mt-32"
    >
        ...
        >
          ...
          <form className="lg:pl-16">
            <h3 className="text-base font-medium tracking-tight text-white">
              Get the lesson straight to your inbox{' '}
            ...
            <div className="mt-4 sm:relative sm:flex sm:items-center sm:py-0.5 sm:pr-2.5">
              <div className="relative sm:static sm:flex-auto">
                ...
                />
                <div className="absolute inset-0 rounded-md border border-white/20 peer-focus:border-purple-300 peer-focus:bg-purple-500 peer-focus:ring-1 peer-focus:ring-purple-300 sm:rounded-xl" />
              </div>
              <Button
                type="submit"
                color="white"
